      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-indigo-900 via-indigo-800 to-violet-900 relative items-center justify-center p-12 overflow-hidden">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <h1 className="text-4xl font-bold text-white leading-tight mb-4">
            Your sprints,<br />
            <span className="bg-gradient-to-r from-indigo-300 to-violet-300 bg-clip-text text-transparent">planned by AI.</span>
          </h1>
          <p className="text-slate-300 text-base leading-relaxed mb-10">
            Sign in to pick up where your team left off — boards, story points, and analytics all in one place.
          </p>

          {/* Floating kanban mini-board */}
          <div className="relative h-48">
            ...
            >
              <div className="text-[10px] uppercase tracking-wide text-indigo-300 font-semibold mb-2">In Progress</div>
              <div className="text-sm text-white font-medium mb-1">API rate limiting</div>
              <div className="flex items-center gap-1.5 text-[11px] text-slate-400"><FiZap className="w-3 h-3 text-amber-400" /> 5 pts</div>
            </motion.div>
            ...
            >
              ...
              <div className="text-sm text-white font-medium mb-1">Auth flow refactor</div>
            ...
            >
              <div className="text-[10px] uppercase tracking-wide text-violet-300 font-semibold mb-2">To Do</div>
              <div className="text-sm text-white font-medium mb-1">Sprint 12 retro</div>
              <div className="flex items-center gap-1.5 text-[11px] text-slate-400"><FiZap className="w-3 h-3 text-amber-400" /> 2 pts</div>
            </motion.div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center bg-white px-4 py-12 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-2 text-slate-500">
            Sign in to continue to AgileMind
          </p>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <motion.button
                ...
                className="w-full flex justify-center items-center py-3 px-4 border border-slate-300 rounded-xl shadow-sm text-sm font-medium text-slate-700 bg-white hover:bg-slate-50 transition-colors"
              >
